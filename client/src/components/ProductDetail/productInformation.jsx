...
class ProductInformation extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      selectedPhoto: props.sortedStyles[0].photos[0] ? props.sortedStyles[0].photos[0].url : '',
      selectedPhotoThumb: props.sortedStyles[0].photos[0] ? props.sortedStyles[0].photos[0].thumbnail_url : '',
